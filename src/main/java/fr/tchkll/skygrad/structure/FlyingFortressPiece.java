...
public class FlyingFortressPiece extends StructurePiece {
    ...
    private static BlockState getStoneBrick()
    {
    ...
    private static BlockState getDeepslateBrick()
    {
        ...
        if(r < 30) return Blocks.CRACKED_DEEPSLATE_BRICKS.defaultBlockState();
    ...
    public void postProcess(WorldGenLevel level, StructureManager structureManager,
        ...
        for (Pixel p : fillPolygon(towers)) {
            ...
            if (box.isInside(pos))
                level.setBlock(pos, getStoneBrick(), 2);
        }
